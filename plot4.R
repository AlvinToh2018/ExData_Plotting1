...
plot(graph_range$Date,as.numeric(as.character(graph_range$Global_active_power)),type="l",  xlab="",ylab="Global Active Power")  

plot(graph_range$Date,as.numeric(as.character(graph_range$Voltage)), type="l",xlab="datetime",ylab="Voltage")
...
plot(graph_range$Date,as.numeric(as.character(graph_range$Global_reactive_power)),type="l",xlab="datetime",ylab="Global_reactive_power")
